            ...
            var AudioPlayerComponent = /** @class */ (function () {
                ...
                AudioPlayerComponent.prototype.playerStart = function (index) {
                    ...
                    this.audioPlayer.addEventListener('ended', function (event) {
                        _this.stepNext(); // If audio ends player steps into next audio
                    });
                ...
                AudioPlayerComponent.prototype.playerPause = function () {
                    ...
                    this.audioPlayer.removeEventListener('ended', function (event) {
                ...
                AudioPlayerComponent.prototype.initPlayer = function (index) {
                    this.audioPlayer.playbackRate = 1;
