(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AudioPlayerComponent = /** @class */ (function () {
                function AudioPlayerComponent(playerStateService, playListService, dialog) {
                    this.dialog = dialog;
                    this.playList = [];
                    this.stateService = playerStateService;
                    this.playListService = playListService;
                }
                AudioPlayerComponent.prototype.openDialogfileUpload = function () {
                    var _this = this;
                    var dialogRef = this.dialog.open(_file_upload_file_upload_component__WEBPACK_IMPORTED_MODULE_5__["FileUploadComponent"]);
                    dialogRef.afterClosed().subscribe(function (result) {
                        var tempAudio;
                        tempAudio = result;
                        if (tempAudio) {
                            _this.playListService.addAudio(tempAudio);
                        }
                        console.log("Dialog result", tempAudio);
                    });
                };
                AudioPlayerComponent.prototype.playerPlay = function (index) {
                    if (!index) {
                        index = 0;
                    }
                    var isPlayStarted = this.playerState.currentTime > 0;
                    if (!isPlayStarted) {
                ...
                AudioPlayerComponent.prototype.playerReady = function (index) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlayListComponent = /** @class */ (function () {
                ...
                PlayListComponent.prototype.deleteAudio = function (index) { console.log('trying to delete audio', index); };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlayerStateService = /** @class */ (function () {
                function PlayerStateService() {
                    ...
                    this.audioPlayerElement.addEventListener('timeupdate', function (event) {
                        _this.timeUpdate();
                    });
                ...
                PlayerStateService.prototype.clearState = function () {
                    this.playerState = {
                        controlList: staticControls,
                        currentAudio: null,
                        currentTime: 0,
                 ...
                 ****************************************************/
                PlayerStateService.prototype.timeUpdate = function () {
                ...
                PlayerStateService.prototype.updateCurrentAudio = function (audio, newIndex) {
